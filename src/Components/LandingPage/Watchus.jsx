...
const Watchus = () => {
  return (
    <div className="flex flex-col w-[32vw]">
        ...
        <h1 className="text-2xl font-semibold tracking-tight leading-tight mb-8">Revolutionizing <span className="font-bold">creativity</span>, <b>design</b>, and <b>innovation</b>, empowering entrepreneurs with accessible, purpose-driven solutions. Join us in this transformative creative journey.</h1>
