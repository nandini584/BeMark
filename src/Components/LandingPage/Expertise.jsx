    ...
    <div className="flex flex-row px-[40px]">
        ...
        <div className="flex flex-row mt-24">
            <div className="flex flex-col mr-16">
                <h1 className="text-base font-Halenior-bold text-[#7B36FF] opacity-60">Specialization</h1>
            ...
            <div className="flex flex-col mr-16">
                <h1 className="text-base font-Halenior-bold text-[#7B36FF] opacity-60">Industry</h1>
